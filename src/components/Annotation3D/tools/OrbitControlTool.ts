...
export  class OrbitControlTool extends BaseTool {
  ...
  public constructor(input: InputEmitter, renderer: Renderer, _camera: OrthographicCamera | PerspectiveCamera, canvas: HTMLCanvasElement){
    super()
    this.input = input;
  ...
  pan = (() => {
    ...
    return ( deltaX: number, deltaY: number ) => {
      ...
      if ( this.object.isPerspectiveCamera ) {
        ...
        // orthographic
        this.panLeft( deltaX * ( camera.right - camera.left ) / this.object.zoom / element.clientWidth, this.object.matrix );
        this.panUp( deltaY * ( camera.top - camera.bottom ) / this.object.zoom / element.clientHeight, this.object.matrix );
